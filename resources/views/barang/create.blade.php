    ...
    <div class="card m-4">
        ...
        <div class="card-body">
            <form action="{{ route('barang.store') }}" method="post">
                ...
                <div class="mb-2">
                    <label for="inputKategori_Id"class="form-label">Kategori Id</label>
                    <input type="text" name="kategori_id" id="inputKategoriId" value="{{ old('kategori_id') }}" class="form-control">
                </div>

                <div class="mb-2">
                    <label for="inputRuangan_Id"class="form-label">Ruangan Id</label>
                    <input type="text" name="ruangan_id" id="inputRuanganId" value="{{ old('ruangan_id') }}" class="form-control">
                </div>

                <div class="mb-2">
                    <label for="inputTahunPengadaan"class="form-label">Tahun Pengadaan</label>
                    <input type="text" name="tahun_pengadaan" id="inputTahunPengadaan" value="{{ old('tahun_pengadaan') }}" class="form-control">
                </div>

                <div class="mb-2">
                    <label for="inputSumberDana"class="form-label">Sumber Dana</label>
                    <input type="text" name="sumber_dana" id="inputSumberDana" value="{{ old('sumber_dana') }}" class="form-control">
                </div>
